    ...
    SecurityFilterChain defaultSecurityFilterChain(HttpSecurity http) throws Exception {
        http.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS).and()
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .mvcMatchers(HttpMethod.GET, "/students/profile/**").hasRole(IRoles.STUDENT)
                        ...
                        .mvcMatchers(HttpMethod.GET, "/professors").hasRole(IRoles.PROFESSOR)
                        .mvcMatchers(HttpMethod.GET, "/professors/profile/**").hasRole(IRoles.PROFESSOR)
                        .mvcMatchers(HttpMethod.PUT, "/professors/profile/**").hasRole(IRoles.PROFESSOR)
                        .mvcMatchers("/professors").hasRole(IRoles.ADMIN)
                        .mvcMatchers("/professors/*").hasRole(IRoles.ADMIN)
