...
public class CareerMapper {
    ...
    public static Career toEntity(CareerDTO careerDTO) throws BadArgumentsException {
    ...
    public static Career createEntity(CareerDTO careerDTO) throws BadArgumentsException {
        if (careerDTO.getName().isBlank()) throw new BadArgumentsException("Name cannot be empty");
        Career careerEntity = new Career();
